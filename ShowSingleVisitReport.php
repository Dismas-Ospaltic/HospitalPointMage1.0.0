...
if(isset($_GET["repoDate"])){
 ...
 ';
 $select_single_visit = mysqli_query($conn, "SELECT pateint_name,hospital_patient_no,visit,visit_time,sent_by,tend_by,discharge_date FROM
 patient_sub_visit WHERE visit_date='{$date}'");
echo '

...
<html>
    <head>
        ...
        <link rel="stylesheet" href="patientVisitStyle.css">
            ...
            <section id="main-content">
                ...
                <section class="search-container">
                    <div class="search-input-wrapper">
                     <input type="search" id="searchSingleVisit" placeholder="search here...">
...
window.onload = function() {
  ...
  displayDailyVisitReportList();
  SearchPatientSingleVisit();
};

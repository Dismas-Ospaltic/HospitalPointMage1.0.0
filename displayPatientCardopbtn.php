...
<button id="btn3" onclick="window.history.pushState({ id: \'100\' }, \'Page 2\', \'/HMSMage/patientCard.php?HSPN='.$row['hospital_patient_no'].'&ODPIDP='.$row['odp_idp_no'].'\'); displayAppointmentCard(); "><i class="fa-solid fa-list-1-2"></i>Fix Appointment</button>
